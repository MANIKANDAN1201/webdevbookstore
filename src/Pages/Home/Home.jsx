...
import LibraryIllustration from "../../Assets/Images/Library_pic1.jpg";
    ...
    <div className="home-component-container">
      ...
      <div className="about-us-container">
        ...
        <p className="about-us-text">
          Welcome to Bookztron, your go-to online bookstore. We are dedicated to
          providing a vast collection of books across various genres to cater to
          all kinds of readers. Whether you're looking for the latest
          bestsellers, classic literature, or educational resources, we have it
          all. Our mission is to foster a love for reading by making books
